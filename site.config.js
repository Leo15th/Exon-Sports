export const siteconfig = {
    // root start
    colors: {
    primary: "#0B0B0B",    // Rich Black (backgrounds, headers)
    secondary: "#1C1C1C",  // Charcoal (cards, sections)
    accent: "#C9A24B",     // Antique Gold (CTA, borders, icons)
    neutral: "#F4F1EA",    // Warm Ivory (text on dark, light sections)
